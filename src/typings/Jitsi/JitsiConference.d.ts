...
export default class JitsiConference {
  ...
  on: ( eventId: JitsiConferenceEvents, handler: (...el: Array<any>) => unknown ) => void; // TODO:
  off: ( eventId: JitsiConferenceEvents, handler: (...el: Array<any>) => unknown ) => void; // TODO:
  ...
  addCommandListener: ( command: string, handler: (...el: Array<any>) => unknown ) => void; // TODO:
  ...
  sendCommand: ( name: string, values: { value: string, attributes?: Record<string, any>, children?: Array<any> } ) => void;
  sendCommandOnce: ( name: string, values: { value: string, attributes?: Record<string, any>, children?: Array<any> } ) => void;
